...
function BhdMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="BHD" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>BHD</Typography>
      </Button>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("BHD", VALDAO_ADDRESS)}>
                        <SvgIcon
                          component={bhdTokenImg}
                          viewBox="0 0 32 32"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">BHD</Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sBHD", SVALDAO_ADDRESS)}>
                        <SvgIcon
                          component={sBhdTokenImg}
                          viewBox="0 0 32 32"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sBHD</Typography>
                      </Button>
